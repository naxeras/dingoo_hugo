...
{
#if defined(GP2X_MODE) || defined(WIZ_MODE) || defined(DINGUX_MODE) || defined(DINGOO_NATIVE)
...
*/
static int 
dingoo_setvolume(int volume)
{
#ifndef GEMEI_X760
/* Dingoo A320 */
    #define MAX_DINGOO_VOLUME 30
#else /* GEMEI_X760 */
    #define MAX_DINGOO_VOLUME 100
#endif /* GEMEI_X760 */
    ...
    */
    volume = volume * MAX_DINGOO_VOLUME / 100;
    
    /* Do check what we send to the hardware */
    if (volume > MAX_DINGOO_VOLUME)
        volume = MAX_DINGOO_VOLUME;
    if (volume < 0)
        volume = 0;
...
# endif /* DINGUX_MODE / DINGOO_NATIVE */
