...
psp_menu_display_save_name()
{
  ...
  psp_sdl_back2_print(300 - (psp_font_width*Length), 220, buffer, PSP_MENU_TEXT2_COLOR);
...
psp_main_menu_save_slot()
{
  ...
  psp_sdl_back2_print( 90, 110, "Saving......", 
                       PSP_MENU_NOTE_COLOR);
  psp_sdl_flip();
...
psp_main_menu_editor()
{
  ...
  sprintf(TmpFileName, "%s" DIRSEP "txt" DIRSEP "%s.txt", HUGO.hugo_home_dir, HUGO.hugo_save_name);
