...
#define PICS_BASEDIR "."  DIRSEP "graphics" DIRSEP

static char *guiStrings[] = 
{
  DIRSEP "keys.png", DIRSEP "keys_t.png", DIRSEP "keys_s.png",
  DIRSEP "keys_c.png", DIRSEP "keys_c_t.png", DIRSEP "keys_s_c.png",
  DIRSEP "nums.png", DIRSEP "nums_t.png", DIRSEP "nums_s.png",
  DIRSEP "nums_c.png", DIRSEP "nums_c_t.png", DIRSEP "nums_s_c.png"
};
