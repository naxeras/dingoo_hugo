...
#ifdef DISABLE_HUGO_GZ_SUPPORT
/* Disabling gz support typically means save/loading is slower (cpu tends to be cheaper than disk IO) */
#define gzFile FILE
#define gzopen fopen
#define gzclose fclose
#define gzwrite(f, b, n) fwrite(b, n, 1, f)
#define gzread(f, b, n) fread(b, n, 1, f)
#endif /* DISABLE_HUGO_GZ_SUPPORT */
